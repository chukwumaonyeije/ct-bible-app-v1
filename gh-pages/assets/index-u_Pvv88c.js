 ...
 */const xk=5*60,Dk=K_("authIdTokenMaxAge")||xk;let Cg=null;const Vk=t=>async e=>{const n=e&&await e.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>Dk)return;const i=n==null?void 0:n.token;Cg!==i&&(Cg=i,await fetch(t,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))};function Ok(t=X_()){const e=pd(t,"auth");if(e.isInitialized())return e.getImmediate();const n=nP(t,{popupRedirectResolver:Ck,persistence:[FP,RP,DE]}),r=K_("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const s=new URL(r,location.origin);if(location.origin===s.origin){const o=Vk(s.toString());wP(n,o,()=>o(n.currentUser)),EP(n,l=>o(l))}}const i=H_("auth");return i&&iP(n,`http://${i}`),n}function Lk(){var t,e;return(e=(t=document.getElementsByTagName("head"))===null||t===void 0?void 0:t[0])!==null&&e!==void 0?e:document}QC({loadJS(t){return new Promise((e,n)=>{const r=document.createElement("script");r.setAttribute("src",t),r.onload=e,r.onerror=i=>{const s=Lt("internal-error");s.customData=i,n(s)},r.type="text/javascript",r.charset="UTF-8",Lk().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});Nk("Browser");const Mk={BASE_URL:"/ct-bible-app-v1/",DEV:!1,MODE:"production",PROD:!0,SSR:!1,VITE_FB_API_KEY:"AIzaSyDk--6OxbeWF9sNq7Mvlgd6-AHoaKN1Py0",VITE_FB_APP_ID:"1:586414609621:web:69872d2e5f5162ecf4be5c",VITE_FB_AUTH_DOMAIN:"ct-bible-app-v1.firebaseapp.com",VITE_FB_MEASUREMENT_ID:"G-NH72QVFBRB",VITE_FB_PROJECT_ID:"ct-bible-app-v1",VITE_FB_SENDER_ID:"586414609621",VITE_FB_STORAGE_BUCKET:"ct-bible-app-v1.firebasestorage.app"},yh=Mk;function qr(t){const e=yh[t];return e||console.warn(`[Firebase] Missing env ${t}`),e??""}const Yu={apiKey:qr("VITE_FB_API_KEY"),authDomain:qr("VITE_FB_AUTH_DOMAIN"),projectId:qr("VITE_FB_PROJECT_ID"),storageBucket:qr("VITE_FB_STORAGE_BUCKET"),messagingSenderId:qr("VITE_FB_SENDER_ID"),appId:qr("VITE_FB_APP_ID"),...yh.VITE_FB_MEASUREMENT_ID?{measurementId:yh.VITE_FB_MEASUREMENT_ID}:{}};function bk(t){return!!(t.apiKey&&t.authDomain&&t.projectId&&t.appId)}let Vi=null;try{bk(Yu)?(Vi=Y_(Yu),console.log("[Firebase] Initialized for project:",Yu.projectId)):console.warn("[Firebase] Skipping initializeApp: incomplete config. UI will still render.")}catch(t){console.warn("[Firebase] initializeApp failed. UI will still render.",t),Vi=null}const hr=Vi?Ok(Vi):null,Pg=Vi?ZR(Vi):null;new $t;async function Fk(){if(!Pg)return[];const t=dC(JR(Pg,"modules"),fC("updatedAt","desc"));return(await vC(t)).docs.map(n=>({id:n.id,...n.data()}))}function jE(...t){return t.filter(Boolean).join(" ")}const zE=Ie.createContext(null);function Uk({children:t}){const[e,n]=Ie.useState(null),[r,i]=Ie.useState(null),[s,o]=Ie.useState(!1);Ie.useEffect(()=>{if(!hr){console.warn("[Auth] Firebase auth not ready; continuing without session");return}const g=TP(hr,n);return()=>g()},[]);const l=g=>async(...R)=>{if(!hr)throw new Error("Auth not initialized");try{return i(null),o(!0),await g(...R)}catch(k){throw i((k==null?void 0:k.message)??"Authentication error"),k}finally{o(!1)}},u=l(async(g,R)=>vP(hr,g,R)),h=l(async(g,R)=>_P(hr,g,R)),f=l(async()=>$P(hr,new $t)),y=l(async()=>IP(hr));return N.jsx(zE.Provider,{value:{user:e,signInEmail:u,signInGoogle:f,doSignOut:y,authError:r,authLoading:s,signUpEmail:h},children:t})}function BE(){const t=Ie.useContext(zE);if(!t)throw new Error("Auth context missing");return t}const jk=[{id:"creation-sda",title:"Creation (SDA Perspective)",kind:"history",bibleVersion:"KJV",updatedAt:Date.now()-1e3*60*60*24*3,contentHtml:`<h2 class="text-xl font-semibold mb-2">Genesis 1–2 (KJV)</h2>
      ...
      <p class="text-gray-700">From earthly services to Christ’s high-priestly ministry—understanding atonement in SDA theology.</p>`,quiz:[{type:"fitb",prompt:"Christ is our High ______ in the heavenly sanctuary.",answer:"Priest"}]}];function Mt({children:t,className:e}){return N.jsx("div",{className:jE("rounded-2xl border bg-white shadow-sm",e),children:t})}function ca({children:t}){return N.jsx("span",{className:"inline-flex items-center gap-1 rounded-full bg-neutral-100 px-3 py-1 text-xs text-neutral-700",children:t})}function zk(){const t=BE(),{signInEmail:e,signInGoogle:n,signUpEmail:r,authError:i,authLoading:s}=t,[o,l]=Ie.useState(!1),[u,h]=Ie.useState("signin"),[f,y]=Ie.useState(""),[g,R]=Ie.useState("");async function k(){u==="signin"?await e(f,g):await r(f,g),l(!1)}return N.jsxs("div",{className:"relative flex items-center gap-2",children:[N.jsx("button",{onClick:()=>{h("signin"),l(D=>!D)},className:"text-sm text-neutral-700 hover:text-neutral-900",children:"Sign in"}),N.jsx("button",{onClick:()=>n(),className:"text-sm px-3 py-2 rounded-xl bg-neutral-900 text-white",disabled:s,children:"Google"}),o&&N.jsxs("div",{className:"absolute top-10 right-0 z-50 w-72 p-4 rounded-2xl border bg-white shadow-lg",children:[N.jsxs("div",{className:"flex items-center justify-between mb-2",children:[N.jsx("div",{className:"text-sm font-semibold",children:u==="signin"?"Sign in":"Create account"}),N.jsx("button",{onClick:()=>h(u==="signin"?"signup":"signin"),className:"text-xs underline",children:u==="signin"?"Need an account?":"Have an account?"})]}),N.jsx("input",{className:"w-full mb-2 rounded-xl border px-3 py-2 text-sm",placeholder:"Email",value:f,onChange:D=>y(D.target.value)}),N.jsx("input",{className:"w-full mb-2 rounded-xl border px-3 py-2 text-sm",placeholder:"Password",type:"password",value:g,onChange:D=>R(D.target.value)}),i&&N.jsx("div",{className:"text-xs text-red-600 mb-2",children:i.replace("Firebase:","").trim()}),N.jsx("button",{onClick:k,className:"w-full px-3 py-2 rounded-xl bg-neutral-900 text-white disabled:opacity-50",disabled:s||!f||!g,children:s?"Please wait…":u==="signin"?"Continue":"Create account"})]})]})}function Bk({quiz:t,onSubmit:e}){const[n,r]=Ie.useState({});function i(){let s=0;t.forEach((l,u)=>{l.type==="mcq"&&n[u]===l.correctIndex&&s++,l.type==="fitb"&&(n[u]??"").trim().toLowerCase()===l.answer.trim().toLowerCase()&&s++});const o=Math.round(s/t.length*100);e(o)}return N.jsx(Mt,{className:"p-6",children:N.jsxs("div",{className:"space-y-6",children:[t.map((s,o)=>N.jsx("div",{className:"space-y-2",children:s.type==="mcq"?N.jsxs("div",{children:[N.jsx("p",{className:"font-medium mb-2",children:s.question}),N.jsx("div",{className:"space-y-2",children:s.options.map((l,u)=>N.jsxs("label",{className:"flex items-center gap-2 cursor-pointer",children:[N.jsx("input",{type:"radio",name:`q${o}`,onChange:()=>r(h=>({...h,[o]:u})),className:"h-4 w-4"}),N.jsx("span",{className:"text-sm",children:l})]},u))})]}):N.jsxs("div",{children:[N.jsx("p",{className:"font-medium mb-2",children:s.prompt}),N.jsx("input",{className:"w-full rounded-xl border px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-neutral-900",placeholder:"Type your answer…",onChange:l=>r(u=>({...u,[o]:l.target.value}))})]})},o)),N.jsx("div",{className:"pt-2",children:N.jsx("button",{onClick:i,className:"px-4 py-2 rounded-xl bg-neutral-900 text-white",children:"Submit"})})]})})}function $k({onStart:t}){return N.jsxs("div",{className:"space-y-10",children:[N.jsxs("section",{className:"text-center",children:[N.jsx("h1",{className:"text-4xl font-semibold tracking-tight",children:"Study Scripture. Retain Truth."}),N.jsx("p",{className:"mt-3 text-neutral-600 max-w-2xl mx-auto",children:"A modern, minimalist Bible study experience grounded in Seventh-day Adventist theology. Read public domain KJV passages, reflect with SDA insights, and cement learning via quick quizzes."}),N.jsxs("div",{className:"mt-6 flex justify-center gap-3",children:[N.jsx("button",{onClick:t,className:"px-5 py-3 rounded-2xl bg-neutral-900 text-white",children:"Browse Modules"}),N.jsx("button",{className:"px-5 py-3 rounded-2xl border",children:"Learn More"})]})]}),N.jsxs("section",{className:"grid gap-4 sm:grid-cols-3",children:[N.jsxs(Mt,{className:"p-5",children:[N.jsx("div",{className:"text-sm uppercase tracking-wide text-neutral-500 mb-2",children:"Approach"}),N.jsx("h3",{className:"font-semibold",children:"SDA Perspective"}),N.jsx("p",{className:"text-sm text-neutral-600 mt-1",children:"Insights emphasize Sabbath, sanctuary, and the great controversy theme."})]}),N.jsxs(Mt,{className:"p-5",children:[N.jsx("div",{className:"text-sm uppercase tracking-wide text-neutral-500 mb-2",children:"Practice"}),N.jsx("h3",{className:"font-semibold",children:"Quiz-Backed Learning"}),N.jsx("p",{className:"text-sm text-neutral-600 mt-1",children:"MCQ + fill-in-the-blank to boost retention and comprehension."})]}),N.jsxs(Mt,{className:"p-5",children:[N.jsx("div",{className:"text-sm uppercase tracking-wide text-neutral-500 mb-2",children:"Experience"}),N.jsx("h3",{className:"font-semibold",children:"Offline-First"}),N.jsx("p",{className:"text-sm text-neutral-600 mt-1",children:"Installable PWA so study continues regardless of connectivity."})]})]})]})}function qk({modules:t,onOpen:e,onQuiz:n}){return N.jsxs("div",{className:"space-y-6",children:[N.jsxs("div",{className:"flex items-end justify-between",children:[N.jsxs("div",{children:[N.jsx("h2",{className:"text-2xl font-semibold",children:"Study Modules"}),N.jsx("p",{className:"text-neutral-600",children:"Bible history, stories, and articles from Chukwuma Theology."})]}),N.jsxs("div",{className:"flex gap-2",children:[N.jsx(ca,{children:"All"}),N.jsx(ca,{children:"History"}),N.jsx(ca,{children:"Stories"}),N.jsx(ca,{children:"Blog"})]})]}),N.jsx("div",{className:"grid gap-4 sm:grid-cols-2",children:t.map(r=>N.jsxs(Mt,{className:"p-5",children:[N.jsxs("div",{className:"flex items-start justify-between gap-3",children:[N.jsxs("div",{children:[N.jsx("div",{className:"text-xs uppercase tracking-wide text-neutral-500",children:r.kind}),N.jsx("h3",{className:"font-semibold text-lg mt-1",children:r.title}),N.jsxs("div",{className:"mt-2 text-sm text-neutral-600",children:["Version: ",r.bibleVersion]})]}),N.jsx("div",{className:"text-xs text-neutral-500",children:new Date(r.updatedAt).toLocaleDateString()})]}),N.jsxs("div",{className:"mt-4 flex items-center gap-2",children:[N.jsx("button",{onClick:()=>e(r.id),className:"px-3 py-2 rounded-xl border",children:"Open"}),N.jsx("button",{onClick:()=>n(r.id),className:"px-3 py-2 rounded-xl bg-neutral-900 text-white",children:"Take Quiz"})]})]},r.id))})]})}function Hk({module:t,onQuiz:e}){return N.jsxs("div",{className:"space-y-6",children:[N.jsxs("div",{className:"flex items-center justify-between",children:[N.jsxs("div",{children:[N.jsx("div",{className:"text-xs uppercase tracking-wide text-neutral-500",children:t.kind}),N.jsx("h2",{className:"text-2xl font-semibold",children:t.title}),N.jsxs("div",{className:"text-sm text-neutral-600",children:[t.bibleVersion," • Updated ",new Date(t.updatedAt).toLocaleDateString()]})]}),N.jsx("button",{onClick:e,className:"px-4 py-2 rounded-xl bg-neutral-900 text-white",children:"Start Quiz"})]}),N.jsx(Mt,{className:"p-6 prose prose-neutral max-w-none",children:N.jsx("div",{dangerouslySetInnerHTML:{__html:t.contentHtml}})})]})}function Wk(){const t=[{label:"Modules completed",value:3},{label:"Average quiz score",value:"88%"},{label:"Study streak",value:"5 days"}];return N.jsxs("div",{className:"space-y-6",children:[N.jsx("h2",{className:"text-2xl font-semibold",children:"Your Progress"}),N.jsx("div",{className:"grid gap-4 sm:grid-cols-3",children:t.map((e,n)=>N.jsxs(Mt,{className:"p-5 text-center",children:[N.jsx("div",{className:"text-sm uppercase tracking-wide text-neutral-500",children:e.label}),N.jsx("div",{className:"mt-2 text-3xl font-semibold",children:e.value})]},n))}),N.jsxs(Mt,{className:"p-6",children:[N.jsx("h3",{className:"font-semibold",children:"Recent Activity"}),N.jsxs("ul",{className:"mt-3 text-sm text-neutral-700 list-disc list-inside space-y-1",children:[N.jsx("li",{children:"Exodus: The Ten Plagues — Quiz score 90%"}),N.jsx("li",{children:"Creation (SDA Perspective) — Completed"}),N.jsx("li",{children:"Reading streak +1 day"})]})]})]})}function Kk({module:t,onDone:e}){return N.jsxs("div",{className:"space-y-6",children:[N.jsxs("div",{children:[N.jsx("div",{className:"text-xs uppercase tracking-wide text-neutral-500",children:"Quiz"}),N.jsx("h2",{className:"text-2xl font-semibold",children:t.title})]}),N.jsx(Bk,{quiz:t.quiz,onSubmit:e})]})}function Gk(){const[t,e]=Ie.useState({name:"home"});function n(r){e(r)}return{route:t,nav:n}}function Qk({children:t,routeName:e,onNav:n}){const{user:r,doSignOut:i}=BE(),s=(o,l)=>N.jsx("button",{onClick:()=>n(l),className:jE("px-3 py-2 rounded-xl text-sm font-medium",e===l.name?"bg-neutral-900 text-white":"text-neutral-700 hover:bg-neutral-200"),children:o});return N.jsxs("div",{className:"min-h-screen bg-neutral-50 text-neutral-900",children:[N.jsx("div",{className:"fixed top-0 inset-x-0 z-40 backdrop-blur bg-white/70 border-b",children:N.jsxs("div",{className:"mx-auto max-w-4xl px-4 h-16 flex items-center justify-between",children:[N.jsxs("div",{className:"flex items-center gap-3",children:[N.jsx("div",{className:"w-8 h-8 rounded-xl bg-neutral-900"}),N.jsx("span",{className:"font-semibold",children:"CT Bible"})]}),N.jsxs("nav",{className:"flex items-center gap-2",children:[s("Home",{name:"home"}),s("Modules",{name:"modules"}),s("Progress",{name:"progress"})]}),N.jsx("div",{className:"flex items-center gap-2",children:r?N.jsxs("span",{className:"text-sm text-neutral-700",children:["Hi, ",r.email??"reader"]}):N.jsx(zk,{})})]})}),N.jsx("main",{className:"mx-auto max-w-4xl px-4 pb-24 pt-20",children:t}),N.jsx("footer",{className:"border-t mt-20 py-8 text-sm text-neutral-500 text-center",children:N.jsxs("div",{className:"flex items-center justify-center gap-3",children:[N.jsxs("span",{children:["© ",new Date().getFullYear()," Chukwuma Theology • Bible Study App (V1)"]}),r&&N.jsx("button",{onClick:i,className:"underline",children:"Sign out"})]})})]})}function Yk(){const{route:t,nav:e}=Gk(),[n,r]=Ie.useState(null),[i,s]=Ie.useState([]),[o,l]=Ie.useState(!0),[u,h]=Ie.useState(null);Ie.useEffect(()=>{let g=!0;return(async()=>{try{h(null);const R=await Fk();g&&s(R)}catch(R){g&&h((R==null?void 0:R.message)??"Failed to load modules")}finally{g&&l(!1)}})(),()=>{g=!1}},[]);const f=i.length?i:jk,y=Ie.useMemo(()=>t.name==="module"||t.name==="quiz"?f.find(g=>g.id===t.id)??f[0]:f[0],[t,f]);return N.jsx(Uk,{children:N.jsxs(Qk,{routeName:t.name,onNav:e,children:[t.name==="home"&&N.jsx($k,{onStart:()=>e({name:"modules"})}),t.name==="modules"&&N.jsxs(N.Fragment,{children:[N.jsx(qk,{modules:f,onOpen:g=>e({name:"module",id:g}),onQuiz:g=>e({name:"quiz",id:g})}),o&&N.jsx(Mt,{className:"p-5",children:"Loading modules…"}),u&&N.jsxs(Mt,{className:"p-5 text-red-600",children:["Error: ",u]})]}),t.name==="module"&&N.jsx(Hk,{module:y,onQuiz:()=>e({name:"quiz",id:y.id})}),t.name==="quiz"&&N.jsx(Kk,{module:y,onDone:g=>{r(g),e({name:"progress"})}}),t.name==="progress"&&N.jsxs("div",{className:"space-y-4",children:[n!==null&&N.jsx(Mt,{className:"p-5",children:N.jsxs("div",{className:"flex items-center justify-between",children:[N.jsxs("div",{children:[N.jsx("div",{className:"text-sm text-neutral-600",children:"Latest quiz"}),N.jsxs("div",{className:"text-2xl font-semibold",children:["Score: ",n,"%"]})]}),N.jsx("button",{onClick:()=>e({name:"modules"}),className:"px-4 py-2 rounded-xl bg-neutral-900 text-white",children:"Keep Studying"})]})}),N.jsx(Wk,{})]})]})})}console.log("🔍 main.tsx: App is about to mount");const kg=document.getElementById("root");kg?Xu.createRoot(kg).render(N.jsx(Mw.StrictMode,{children:N.jsx(Xk,{children:N.jsx(Yk,{})})})):console.error("❌ No root element found! Check index.html");function Xk({children:t}){try{return console.log("✅ AppGuard: Rendering App"),N.jsx(N.Fragment,{children:t})}catch(e){return console.error("💥 App crashed during render:",e),N.jsxs("div",{style:{padding:20,color:"red"},children:[N.jsx("h1",{children:"Something went wrong loading the app."}),N.jsx("pre",{children:String(e)})]})}}
